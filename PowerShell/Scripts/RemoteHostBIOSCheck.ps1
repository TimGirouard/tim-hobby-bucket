...
$CredArray = @()
$user1 = "MERCY\fn0001"
$pass1 = cat C:\passy\securestring1.txt | convertto-securestring
$CredArray += ($user1, $pass1)
$cred = new-object -typename System.Management.Automation.PSCredential `
         -argumentlist $CredArray[0], $CredArray[1]
...
function GetInfo{ 
    ...
    switch ($MenuSelection){ 
        1 { #PC Serial Number 
            gwmi -computer $compname -Credential $cred Win32_BIOS | Select-Object SerialNumber | Format-List 
            Pause 
            CheckHost 
          } 
           
        2 { #PC Printer Information 
            gwmi -computer $compname -Credential $cred Win32_Printer | Select-Object DeviceID,DriverName, PortName | Format-List 
            Pause 
            CheckHost           
          } 
           
        3 { #Current User 
            gwmi -computer $compname -Credential $cred Win32_ComputerSystem | Format-Table @{Expression={$_.Username};Label="Current User"} 
            "" 
        ...
        4 { #OS Info 
            gwmi -computer $compname -Credential $cred Win32_OperatingSystem | Format-List @{Expression={$_.Caption};Label="OS Name"},SerialNumber,OSArchitecture 
            Pause 
            CheckHost        
          } 
           
        5 { #System Info 
            gwmi -computer $compname -Credential $cred Win32_ComputerSystem | Format-List Name,Domain,Manufacturer,Model,SystemType 
            Pause 
            CheckHost          
          }         
           
        6 { #Add/Remove Program List 
            gwmi -computer $compname -Credential $cred Win32_Product | Sort-Object Name | Format-Table Name,Vendor,Version 
            Pause 
            CheckHost 
          } 
        ...
        7 { #Process Listx 
            ...
            gwmi -computer $compname -Credential $cred Win32_Process | Select-Object Caption,Handle | Sort-Object Caption | Format-Table 
            Pause 
            CheckHost          
          } 
           
        8 { #Service List 
            gwmi -computer $compname -Credential $cred Win32_Service | Select-Object Name,State,Status,StartMode,ProcessID, ExitCode | Sort-Object Name | Format-Table 
            Pause 
            CheckHost         
          } 
         
        9 { #USB Devices 
            gwmi -computer $compname -Credential $cred Win32_USBControllerDevice | %{[wmi]($_.Dependent)} | Select-Object Caption, Manufacturer, DeviceID | Format-List 
            Pause 
            CheckHost           
          } 
           
        10 { #Uptime 
            $wmi = gwmi -computer $compname -Credential $cred Win32_OperatingSystem 
        ...
        11 { #Disk Info 
            $wmi = gwmi -computer $compname -Credential $cred Win32_logicaldisk 
        ...
        12 { #Memory Info 
            $wmi = gwmi -computer $compname -Credential $cred Win32_PhysicalMemory 
            foreach($device in $wmi){ 
        ...
        13 { #Processor Info 
            gwmi -computer $compname -Credential $cred Win32_Processor | Format-List Caption,Name,Manufacturer,ProcessorId,NumberOfCores,AddressWidth   
            Pause 
            CheckHost 
          } 
        14 { #Monitor Info 
