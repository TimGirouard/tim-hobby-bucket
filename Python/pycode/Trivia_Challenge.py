...
def highscores(name, finalscore, file_name):
...
#The old-fashioned way
    #the_file = open_file(file_name, "a")
    #line = (name,"\t",str(finalscore),"\n")
...
def main():
    trivia_file = open_file("../Res/trivia.txt", "r")
    ...
    highscores(name,score,"high_scores.dat")
main()
input("\n\nPress the enter key to exit.")
