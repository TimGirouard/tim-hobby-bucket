# Longevity
# Demonstrates text and entry widgets, and the Grid layout

from tkinter import *

class Application(Frame):
    """ A GUI application which can reveal a secret. """
    ...
    def create_widget(self):
        """ Create a password entry and result display. """
    ...
    def reveal(self):
        ...
        if contents == "secret":
            message = "Here's the secret to living 100: live to 99 " \
